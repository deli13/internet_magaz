...
class ViewController extends \yii\web\Controller
{
    public function beforeAction($action)
    {
        ...
        if (($limit=Yii::$app->request->get('limit'))!=null){
            $session->set('limit',(int)$limit);
        } else {
            if(!is_numeric($session->get('limit'))){
                $session->set('limit',9);
            }
        }
    ...
    public function actionIndex(){
        ...
        $models=$productAll->offset($pages->offset)->limit(Yii::$app->session->get('limit'))->all();
